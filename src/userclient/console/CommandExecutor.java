...
public class CommandExecutor {
    ...
    public CommandExecutor(UserInteraction user, PeerInfo thisPeer, FileAccess files, FileSystemIndex fileIndex, P2PNetwork network) {
        this.user = user;

        CommandFactory commandFactory = new DefaultCommandFactory(thisPeer, files, fileIndex, network);
